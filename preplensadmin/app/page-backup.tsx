  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <p className="text-center text-gray-600">Welcome to PrepLens Admin Dashboard</p>
        <p className="text-center text-sm text-gray-500 mt-2">Logged in as: {userEmail}</p>
        <button 
          onClick={onLogout}
